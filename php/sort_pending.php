<?php
/*Ebben a fájlban történik az adatbázisban tárolt folyamatban lévő feladat elemek lekérése, és továbbítása*/
...
//Amennyiben sikeres a csatlakozás indít egy sql lekérdezést, mellyel lekéri az adatbázisban tárolt összes olyan adatot, melynek státusza hamis
//majd id alapján csökkenő sorrendbe állítja őket
//Sikertelen kapcsolat esetén megszakítja a folyamatot
if($conn){
	$results = $conn->query("SELECT id, description, status FROM todos WHERE status=false ORDER BY id DESC");
